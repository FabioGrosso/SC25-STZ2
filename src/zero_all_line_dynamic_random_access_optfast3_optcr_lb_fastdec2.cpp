...
template <int Block, typename T>
void preprocess_block_split_zslab_const(const T* sub_block, const T* ref, T* diff,
...
template <int Block, typename T>
void depreprocess_block_split_zslab_const(const T* deData, const T* ref, T* de_sub,
                                          int dim_x, int dim_y, int dim_z, int z_begin, int z_end)
{
    if (dim_x < 4 || dim_y < 4 || dim_z < 4) {
        depreprocess_block_const<Block>(deData, ref, de_sub, dim_x, dim_y, dim_z,
...
template <int Block, typename T>
void depreprocess_block_zslab_to_full_const(const T* deData, const T* ref, T* full_out,
                                            int dim_x, int dim_y, int dim_z, int z_begin, int z_end)
{
